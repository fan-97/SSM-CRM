...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">FFFF客户管理系统 v1.0</a>
		</div>
		<!-- /.navbar-header -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
									...
									<c:forEach items="${page.list}" var="list">
										<tr align="center">
											...
											<td><a href="#" class="btn btn-primary btn-xs"
												...
												onclick="editCustomer(${list.custId})">修改</a> <a href="#"
												class="btn btn-danger btn-xs"
												onclick="deleteCustomer(${list.custId})">删除</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
						...
						<div class="col-md-12 text-left">
							<button class="btn btn-primary" id="deletes">删除所选项</button>
						</div>
						<div class="col-md-12 text-right">
							<!-- 此处设置分页 -->
							<nav aria-label="Page navigation">
							  <ul class="pagination">
								<c:if test="${page.head == false}">
							    <li>
							      <a href="${pageContext.request.contextPath }/${page.url}?currentPage=${page.prePage}" aria-label="Previous">
							        <span aria-hidden="true">&laquo;</span>
							      </a>
							    </li>
								</c:if>
							    <c:forEach begin="${ page.startPage}" end="${page.endPage }" var="num" >
									<li><a href="${pageContext.request.contextPath }/${page.url}?currentPage=${num}">${num}</a></li>
							    </c:forEach>
								<c:if test="${page.tail == false}">    
								<li>
							      <a href="${pageContext.request.contextPath }/${page.url}?currentPage=${page.nextPage}" aria-label="Next">
	...
	<div class="modal fade" id="customerInsertDialog" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" id="insert_customer_form">
						<div class="form-group">
							<label for="edit_customerName" class="col-sm-2 control-label">客户名称</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="客户名称" name="custName"/>
							</div>
						</div>
						<div class="form-group">
							<label for="edit_customerFrom"
						...
						<div class="form-group">
							<label for="edit_linkMan" class="col-sm-2 control-label">联系人</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="联系人" name="custLinkman"/>
							</div>
						</div>
						<div class="form-group">
							<label for="edit_phone" class="col-sm-2 control-label">固定电话</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="固定电话" name="custPhone"/>
							</div>
						</div>
						<div class="form-group">
							<label for="edit_mobile" class="col-sm-2 control-label">移动电话</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="移动电话" name="custMobile"/>
							</div>
						</div>
						<div class="form-group">
							<label for="edit_zipcode" class="col-sm-2 control-label">邮政编码</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="邮政编码" name="custZipcode"/>
							</div>
						</div>
						<div class="form-group">
							<label for="edit_address" class="col-sm-2 control-label">联系地址</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" placeholder="联系地址" name="custAddress"/>
							</div>
						</div>
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" class="btn btn-primary" onclick="insertCustomer()">确定添加</button>
				</div>
			</div>
		</div>
	</div>
